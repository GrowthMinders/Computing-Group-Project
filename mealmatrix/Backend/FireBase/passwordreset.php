...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
      ...
      <link rel="stylesheet" href="http://192.168.195.67/Firebase/web/ResetPassword.css" type="text/css" />
      <script src = "http://192.168.195.67/Firebase/web/validation.js"></script>
...
<body>
    <div class="container">
        ...
        <form name="reset" action="http://192.168.195.67/Firebase/web/updatepassword.php" method="POST">
            <div style="margin-bottom: 50px;">
