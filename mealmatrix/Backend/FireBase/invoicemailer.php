...
<body>
    <div class="invoice-container">
        <div class="invoice-header">
            <center><h1 class="restaurant-name">Meal Matrix</h1></center>
        </div>

        <div class="invoice-logo">
            <img src="https://1drv.ms/i/c/d1ec707daa45f29c/IQTVJEqUhp5jSLF7gBPCe32BARImmENCfq56ctcVULn79pc?width=1024" alt="Meal Matrix Logo">
        </div>


                <div class="info-label" style="margin-left:20px;">INVOICE: #$invoiceno</div>
              <div style="display: flex;">  
                <div class="info-label" style="margin-left:20px; margin-right:45%;">DATE: $today</div>
                <div class="info-label">TIME: $time</div>
              </div>  
...
$sql2 = "SELECT oid,name,supply,qty FROM orders WHERE iino = ?";
...
$invoiceHTML .= <<<HTML
        ...
        <div class="footer">
            ...
            <p>Meal Matrix<br>Pitipana, Homagama</p>
            <p>Phone: +(94) 76 157 1745<br>Email: MealMatrixCGP@outlook.com</p>
        </div>
    </div>
</body>
</html>
...
try {
    ...
    if ($mail->send()) {
        ...
        echo "<script>
                 window.location.href = 'http://192.168.177.67/FireBase/state/paymentsuccess.php?total=$total&invoice=$invoiceno';
              </script>
              <noscript>
                 <meta http-equiv='refresh' content='0;url=http://192.168.177.67/FireBase/state/paymentsuccess.php?total=$total&invoice=$invoiceno' />
             </noscript>";
    } else {
