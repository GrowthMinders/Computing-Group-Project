...
<body>
    <div class="invoice-container">
        <div class="invoice-header">
            <center><img src="https://1drv.ms/i/c/d1ec707daa45f29c/IQTVJEqUhp5jSLF7gBPCe32BARImmENCfq56ctcVULn79pc?width=1024" stylele="displya:flex; width: 80px; height: auto;" alt="Meal Matrix Logo"><h1 class="restaurant-name">Ocean</h1></center>
        </div>
