...
<body>
    <div class="invoice-container">
        <div class="invoice-header">
            <h1 class="restaurant-name">Finagle</h1>
...
$invoiceHTML .= <<<HTML
        ...
        <div class="footer">
            <div class="thank-you">Thank you, come again Finagle</div>
            <p>Meal Matrix • Pitipana, Homagama</p>
            <p>Phone: +(94) 76 157 1745 • Email: Finagle@gmail.com</p>
        </div>
    </div>
</body>
</html>
...
try {
    ...
    // Recipients
    $mail->setFrom('Finagle@gmail.com', 'Finagle');
