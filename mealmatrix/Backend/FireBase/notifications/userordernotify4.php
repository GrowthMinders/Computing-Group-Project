...
<body>
    <div class="invoice-container">
        <div class="invoice-header">
            <center><img src="https://1drv.ms/i/c/d1ec707daa45f29c/IQTVJEqUhp5jSLF7gBPCe32BARImmENCfq56ctcVULn79pc?width=1024" stylele="displya:flex; width: 80px; height: auto;" alt="Meal Matrix Logo"><h1 class="restaurant-name">Leyons</h1></center>
        </div>
...
$invoiceHTML .= <<<HTML
        ...
        <div class="footer">
            ...
            <p>Leyons<br>Pitipana, Homagama</p>
            <p>Phone: +(94) 76 157 1745<br>Email: Leyons@gmail.com</p>
        </div>
    </div>
</body>
</html>
...
try {
    ...
    // Recipients
    $mail->setFrom('Leyons@gmail.com', 'Leyons');
