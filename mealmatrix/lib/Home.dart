                      ...
                      onTap: () async {
                        try {
                          final response = await http.get(
                            Uri.parse(
                              'http://10.16.166.111/Firebase/Menus/Finagle.php',
                            ),
                          );
                    ...
                    _buildCanteenItem(
                      ...
                      onTap: () async {
                        try {
                          final response = await http.get(
                            Uri.parse(
                              'http://10.16.166.111/Firebase/Menus/Hostel.php',
                            ),
                          );
                    ...
                    _buildCanteenItem(
                      ...
                      onTap: () async {
                        try {
                          final response = await http.get(
                            Uri.parse(
                              'http://10.16.166.111/Firebase/Menus/Edge.php',
                            ),
                          );
                    ...
                    _buildCanteenItem(
                      ...
                      onTap: () async {
                        try {
                          final response = await http.get(
                            Uri.parse(
                              'http://10.16.166.111/Firebase/Menus/Audi.php',
                            ),
                          );
