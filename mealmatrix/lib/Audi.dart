// ignore_for_file: fileNames, deprecated_member_use, use_build_context_synchronously, file_names
...
class AudiState extends State<Audi> {
  ...
  Future<void> fetchProducts() async {
    try {
      final response = await http.get(
        Uri.parse('http://192.168.195.67/Firebase/Menus/Audi.php'),
      );
